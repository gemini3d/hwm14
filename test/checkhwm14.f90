...
external :: hwm14, dwm07, dwm07b

integer            :: iyd
real(real32)            :: sec,alt,glat,glon,stl,f107a,f107,ap(2)
real(real32)            :: w(2), qw(2), dw(2)
real(real32)            :: mlt, mlat, kp, mmpwind, mzpwind
real(real32)            :: ut, apqt(2)
integer            :: day
...
glat = -45.0
glon = -85.0
stl = pershift(ut + glon/15.0, [0., 24.] )
ap(2) = 80.0
apqt(2) = -1.0
...
ap(2) = 48.0
apqt(2) = -1.0
print '(/,/,a)', 'magnetic activity profile'
...
kp = 6.0
mlt = 3.0
print '(/,/,a)', 'dwm: magnetic latitude profile'
...
kp = 6.0
mlat = 45.0
print '(/,/,a)', 'dwm: magnetic local time profile'
...
real(real32) pure function pershift(x, perint)

real(real32), parameter :: tol=1e-4
